...
class Application:
    ...
    def __init__(self):
        ...
        self.T1.config(text="Alphabet  - ", font=("Helvetica", 30, "bold"))
        ...
        self.T2.config(text="Word  - ", font=("Helvetica", 30, "bold"))
        ...
        self.T3.config(text="Sentence - ", font=("Helvetica", 30, "bold"))
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            self.panel3.config(text=self.current_symbol, font=("Helvetica", 30))

            self.panel4.config(text=self.word, font=("Helvetica", 30))

            self.panel5.config(text=self.str, font=("Helvetica", 30))

            predicts = self.hs.suggest(self.word)

            if(len(predicts) > 1):

                self.bt1.config(text=predicts[0], font=("Helvetica", 20))
            ...
            if(len(predicts) > 2):
                ...
                self.bt2.config(text=predicts[1], font=("Helvetica", 20))
            ...
            if(len(predicts) > 3):
                ...
                self.bt3.config(text=predicts[2], font=("Helvetica", 20))
